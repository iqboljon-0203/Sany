          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="flex gap-3 mt-8">
                <a href={companyInfo.telegram} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl bg-[#0088cc] flex items-center justify-center hover:scale-105 transition-transform">
                ...
                <a href={companyInfo.whatsapp} target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-xl bg-[#25D366] flex items-center justify-center hover:scale-105 transition-transform">
                  <svg className="w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
