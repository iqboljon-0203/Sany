  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-3xl font-heading font-bold text-gray-900">Servis xizmatlari</h2>
          <p className="text-gray-500 mt-1">"Servis va ehtiyot qismlar" sahifasidagi kartochkalar</p>
        </div>
        <Link href="/admin/services/new" className="flex items-center gap-2 bg-sany-red hover:bg-red-700 text-white font-bold py-3 px-6 rounded-lg transition-colors">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          <tbody>
            {services?.map((s) => (
              <tr key={s.id} className="border-b border-gray-50 hover:bg-gray-50/50">
                ...
                <td className="py-4 px-6 text-gray-600">{s.icon}</td>
                ...
                <td className="py-4 px-6">
                  <div className="flex items-center justify-end gap-1">
                    <Link href={`/admin/services/${s.id}/edit`} className="text-blue-500 hover:text-blue-700 p-2 hover:bg-blue-50 rounded-lg transition-colors">
        ...
        {(!services || services.length === 0) && (
          <div className="text-center py-12 text-gray-400">Hali servis xizmatlari qo'shilmagan</div>
        )}
      </div>
    </div>
  );
